...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-de0ffa968b5a19102cdb73625f149d5f.png)

**不管是不是面试需要，我们都要知道，日常开发中的这几个状态码的含义哈：**

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-0953009dec9311039e7eedcd69dd6f07.png)

### 2. HTTP 常用的请求方式，区别和用途？

**思路:** 这道题主要考察候选人，是否掌握**HTTP请求方式**这个基础知识点，我们用得比较多就是**GET和POST**啦。

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-24c57f6fb43b3c2766849173af549dee.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-99845059382a3c88ea6190ef462d5432.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-1d6684f23ca9fad8e14a636e9d2b3d36.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-9c2878c02a4e5545681e7c7b478e7b8c.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-2fc53ca265032a799cb042bef2328eff.png)Https工作流程
...
数字证书是指在互联网通讯中标志通讯各方身份信息的一个数字认证，人们可以在网上用它来识别对方的身份。它的出现，是为了避免身份被篡改冒充的。比如Https的数字证书，就是为了避免公钥被中间人冒充篡改：![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-203531ea8afd45f9e5977a413fdf0d39.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-5160c7c63880378968c9482fbd50b965.png)对称加密

非对称加密：指的是加密和解密使用不同的密钥（即公钥和私钥）。公钥与私钥是成对存在的，如果用公钥对数据进行加密，只有对应的私钥才能解密。常见的非对称加密算法有RSA。

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-4c5bb2ec3c707d21fa13bed41beb9675.png)非对称加密
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-7f57724c1058b99576f01aa357d09e4c.png)DNS解析查找过程
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-31e42588913eadf80cb3e3e4e758f522.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-d58966fe4854169509511d6bfc90de9d.png)Http请求过程
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-cefd503ecf09d013ccca358f11037b83.png)

- forward 的工作原理

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-715a25ba54d8cfa72f52e05bc456f6fc.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-7fd7ced8659cbab7f5b89fc5dd808e62.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-1a7151f7c2bb75d9f9f56a0e5184c1c1.png)

来看个图吧：

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-644bd68fcbe1dfa2f637b894aac49579.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-faa187d21caaf4e7283eb57118ab21dc.png)IP地址分类
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-44ee0cb73ea8397feb1977d138f8f995.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-eaaf3fdfd9c7a2b0390fa7a7973f2218.png)TCP三次握手
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-f795189dd1254b2b5765b0a617198b9c.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-8d9d9e5c274d6b4cc3deb1767d67d1f8.png)TCP四次挥手过程
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-d1851a1a8ede59ee850fd57e2f09b05b.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-8dec9e57094f083991b19a6ba95c49fe.png)TCP的粘包和拆包
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-7038b6e7d52a9cc580b6071a705ad61a.png)三次握手
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-ae709e0823e9e85ae50a98d6254ef491.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-886a4ca16926fd89d193095a8c6ccb5f.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-8b9d6208fc78c82a044d96f57d5ff787.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-0bce7b07782db19233b98cdd54ed6121.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-373e0f394792af9c44face0f2852abff.png)

这真的是**辛辛苦苦几十年，一朝回到解放前**。其实还有更好的处理方式，就是**快速重传**。发送方收到3个连续重复的ACK时，就会快速地重传，不必等待**RTO超时**再重传。

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-311271a6e184c49c37a2e3b2bfd9af61.png)image.png
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-8537366c7623840fd7065dd671ddbe40.png)

### 46.请简述TCP和UDP的区别

**思路：** 这道题，校招的时候，问的概率高点，概念性的东西，**TCP是面向连接，而UDP是无连接**。

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-fd1699aa297fdd9d109808150b5a71fa.png)TCP和UDP对比

### 47. 说说TCP是如何确保可靠性的呢？

**思路：** TCP是可靠的连接，为什么具有可靠性呢？记住这些点：连接和断开的可靠性（三次握手，四次挥手）、有状态（哪些数据发送了，哪些没发）、可控制（超时重传、流量控制、拥塞控制等）。

![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-40cdc0971e2f18c22df708ddeca79ade.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-cf87753017b42de921f71c11746cc6cf.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-69f6f681275c215367e3018831d76ac8.png)
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-fc905a42c5917b66a1d9476b7fa1e71b.png)快速重传流程
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-2f299dcc517551ba3f3e2da95457e661.png)SACK机制
...
![img](http://mianbaoban-assets.oss-cn-shenzhen.aliyuncs.com/xinyu-images/MBXY-CR-597f59d6bb0af8567da78be599e27ddc.png)D-SACK简要流程

### 

**觉得文章不错的，欢迎点赞、在看****和****转发，感谢感谢**

### 参考资料 

[1]http的长连接和短连接（史上最通俗！）: *https://www.jianshu.com/p/3fc3646fad80*[2]Cookie和Session的区别: *https://zhuanlan.zhihu.com/p/66754258*[3]ARP协议的工作机制详解: *http://c.biancheng.net/view/6388.html*[4]ARP协议工作流程: *https://blog.csdn.net/qq_44041062/article/details/109844155*[5]一文搞定所有计算机网络面试题: *https://segmentfault.com/a/1190000038526729*