...
| 题号 | 题目                                                         |
| ---- | ------------------------------------------------------------ |
| 1    | [Golang中除了加Mutex锁以外还有哪些方式安全读写共享变量](http://wearygods.online/articles/2021/04/19/1618823886966.html#Golang中除了加Mutex锁以外还有哪些方式安全读写共享变量) |
| 2    | [无缓冲Chan的发送和接收是否同步](http://wearygods.online/articles/2021/04/19/1618823886966.html#无缓冲Chan的发送和接收是否同步) |
| 3    | [Golang并发机制以及它所使用的CSP并发模型](http://wearygods.online/articles/2021/04/19/1618823886966.html#Golang并发机制以及它所使用的CSP并发模型) |
| 4    | [Golang中常用的并发模型](http://wearygods.online/articles/2021/04/19/1618823886966.html#Golang中常用的并发模型) |
| 5    | [Go中对nil的Slice和空Slice的处理是一致的吗](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中对nil的Slice和空Slice的处理是一致的吗) |
| 6    | [协程和线程和进程的区别](http://wearygods.online/articles/2021/04/19/1618823886966.html#协程和线程和进程的区别) |
| 7    | [Golang的内存模型中为什么小对象多了会造成GC压力](http://wearygods.online/articles/2021/04/19/1618823886966.html#Golang的内存模型中为什么小对象多了会造成gc压力) |
| 8    | [Go中数据竞争问题怎么解决](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中数据竞争问题怎么解决) |
| 9    | [什么是channel，为什么它可以做到线程安全](http://wearygods.online/articles/2021/04/19/1618823886966.html#什么是channel，为什么它可以做到线程安全) |
| 10   | [Golang垃圾回收算法](http://wearygods.online/articles/2021/04/19/1618823886966.html#Golang垃圾回收算法) |
| 11   | [GC的触发条件](http://wearygods.online/articles/2021/04/19/1618823886966.html#GC的触发条件) |
| 12   | [Go的GPM如何调度](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的GPM如何调度) |
| 13   | [并发编程概念是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#并发编程概念是什么) |
| 14   | [Go语言的栈空间管理是怎么样的](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go语言的栈空间管理是怎么样的) |
| 15   | [Goroutine和Channel的作用分别是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Goroutine和Channel的作用分别是什么) |
| 16   | [怎么查看Goroutine的数量](http://wearygods.online/articles/2021/04/19/1618823886966.html#怎么查看Goroutine的数量) |
| 17   | [Go中的锁有哪些](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的锁有哪些) |
| 18   | [怎么限制Goroutine的数量](http://wearygods.online/articles/2021/04/19/1618823886966.html#怎么限制Goroutine的数量) |
| 19   | [Channel是同步的还是异步的](http://wearygods.online/articles/2021/04/19/1618823886966.html#Channel是同步的还是异步的) |
| 20   | [Goroutine和线程的区别](http://wearygods.online/articles/2021/04/19/1618823886966.html#Goroutine和线程的区别) |
| 21   | [Go的Struct能不能比较](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的Struct能不能比较) |
| 22   | [Go的defer原理是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的defer原理是什么) |
| 23   | [Go的select可以用于什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的select可以用于什么) |
| 24   | [Go的Context包的用途是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的Context包的用途是什么) |
| 25   | [Go主协程如何等其余协程完再操作](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go主协程如何等其余协程完再操作) |
| 26   | [Go的Slice如何扩容](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的Slice如何扩容) |
| 27   | [Go中的map如何实现顺序读取](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的map如何实现顺序读取) |
| 28   | [Go中CAS是怎么回事](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中CAS是怎么回事) |
| 29   | [Go中的逃逸分析是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的逃逸分析是什么) |
| 30   | [Go值接收者和指针接收者的区别](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go值接收者和指针接收者的区别) |
| 31   | [Go的对象在内存中是怎样分配的](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go的对象在内存中是怎样分配的) |
| 32   | [栈的内存是怎么分配的](http://wearygods.online/articles/2021/04/19/1618823886966.html#栈的内存是怎么分配的) |
| 33   | [堆内存管理怎么分配的](http://wearygods.online/articles/2021/04/19/1618823886966.html#堆内存管理怎么分配的) |
| 34   | [Go中的defer函数使用下面的两种情况下结果是什么](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的defer函数使用下面的两种情况下结果是什么) |
| 35   | [在Go函数中为什么会发生内存泄露](http://wearygods.online/articles/2021/04/19/1618823886966.html#在Go函数中为什么会发生内存泄露) |
| 36   | [Go中new和make的区别](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中new和make的区别) |
| 37   | [G0的作用](http://wearygods.online/articles/2021/04/19/1618823886966.html#G0的作用) |
| 38   | [Go中的锁如何实现](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的锁如何实现) |
| 39   | [Go中的channel的实现](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的channel的实现) |
| 40   | [Go中的map的实现](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的map的实现) |
| 41   | [Go中的http包的实现原理](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中的http包的实现原理) |
| 42   | [Goroutine发生了泄漏如何检测](http://wearygods.online/articles/2021/04/19/1618823886966.html#Goroutine发生了泄漏如何检测) |
| 43   | [Go函数返回局部变量的指针是否安全](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go函数返回局部变量的指针是否安全) |
| 44   | [Go中两个Nil可能不相等吗](http://wearygods.online/articles/2021/04/19/1618823886966.html#Go中两个Nil可能不相等吗) |
| 45   | [Goroutine和KernelThread之间是什么关系](http://wearygods.online/articles/2021/04/19/1618823886966.html#Goroutine和KernelThread之间是什么关系) |
| 46   | [为何GPM调度要有P](http://wearygods.online/articles/2021/04/19/1618823886966.html#为何GPM调度要有P) |

#### Golang中除了加Mutex锁以外还有哪些方式安全读写共享变量

Golang中 Goroutine 可以通过 **Channel** 进行**安全读写共享变量**,还可以通过**原子性操作**进行.
...
Goroutine 是Golang实际并发执行的实体，它底层是使用协程(coroutine)实现并发，coroutine是一种运行在**用户态的用户线程**，类似于greenthread，go底层选择使用coroutine的出发点是因为，
...
它是包括一个程序的**运行环境、现场和快照**等。每个程序要运行时，都需要知道当前程序的运行状态，通常Go 将这些封装在一个 Context 里，再将它传给要执行的 goroutine 。
...
![65.jpg](https://b3logfile.com/file/2021/04/65-9012abf2.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
![60.jpg](https://b3logfile.com/file/2021/04/2-d57d9848.jpeg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
![64.jpg](https://b3logfile.com/file/2021/04/64-5172766f.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
通常来说，如果P从其他的P那里要拿任务的话，一般就拿 `run queue`的一半，这就确保了每个OS线程都能充分的使用。
![129.jpg](https://b3logfile.com/file/2021/04/129-ca4334d8.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
当方法作用于值类型接收者时，Go语言会在代码运行时将接收者的值**复制**一份。在值类型接收者的方法中可以获取接收者的成员值，但修改操作只是针对副本，无法修改接收者变量本身。
...
![130.jpg](https://b3logfile.com/file/2021/04/130-5ba572e0.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)

堆内存管理中主要是三部分, 1.分配内存块，2.回收内存块, 3.组织内存块。
![131.jpg](https://b3logfile.com/file/2021/04/131-d92ee255.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)

一个内存块包含了3类信息，如下图所示，元数据、用户数据和对齐字段，内存对齐是为了提高访问效率。下图申请5Byte内存的时候，就需要进行内存对齐。
![132.jpg](https://b3logfile.com/file/2021/04/132-e643a2cf.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
在Go中 go作为一个特殊的goroutine，为 scheduler 执行调度循环提供了场地（栈）。对于一个线程来说，go 总是它第一个创建的 goroutine。
...
![138.jpg](https://b3logfile.com/file/2021/04/138-7427f45d.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
![139.jpg](https://b3logfile.com/file/2021/04/139-f8b66495.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
![141.jpg](https://b3logfile.com/file/2021/04/141-b5d6fb1a.jpg?imageView2/2/w/1280/format/jpg/interlace/1/q/100)
...
标题：Golang 常见面试题
作者：[疲惫的怪神明](http://wearygods.online/)
...
- init函数**先于**main函数**自动执行**，**不能被其他函数调用**；
- init函数没有输入参数、返回值；
- 每个包可以有多个init函数；
- **包的每个源文件也可以有多个init函数**，这点比较特殊；
- 同一个包的init执行顺序，golang没有明确定义，编程时要注意程序不要依赖这个执行顺序。  （同一个包，没有执行顺序）
...
`init`函数和其他函数最大的区别之一就是, 同一个 package 或源文件中, 可以有很多个. 我们看下面的例子:
...
如果同一个 Package 下的多个源文件中都有`init`函数, 也是没有问题的.

##### **2. 生命周期**

> `init` is called after all the variable declarations in the package have evaluated their initializers, and those are evaluated only after all the imported packages have been initialized. [Link](https://link.zhihu.com/?target=https%3A//golang.org/doc/effective_go.html%23init)

`init`函数在一个 package 中的所有全局变量都初始化完成之后, 才开始运行. 这一点非常方便代码的组织. 例如当一个package 中有非常多的方法或函数, 这些方法逻辑上都处于同一个级别, 进一步拆分 package 并不合理. 这时候我们就可以将这些方法或函数放在多个源文件中. 而对这些方法或函数初始化的`init`函数可以和对应的逻辑放在一起, 这也能体现代码设计上的 Cohesion.

例如在一个名为`api`的 package 中:
...
这对很多需要维护全局唯一的一些特性非常有用, 例如在流行的日志工具[logrus](https://zhuanlan.zhihu.com/p/88128042/edit)的实现中, 为了提升获取时间的性能, logrus 在初始化的时候获取了系统的基准时间, 而这个时间需要全局唯一, 并且只需要获取一次. 代码如下:
...
> `init` function is niladic. [Link](https://link.zhihu.com/?target=https%3A//golang.org/doc/effective_go.html)

如果我们给`init`函数写上输入参数或输出参数会怎么样呢?`init`函数会不会变成一个普通的函数? 答案是:

> func init must have no arguments and no return values.

Compiler 会告诉我们, 这样写是语法错误的, 这也说明了`init`函数在 Golang 语法体系中的特殊性.
...
在上面的代码中, 我们导入了 MySQL 的 Driver, 却没有显示地使用它, 那这行导入实际上发生了什么呢, 如果我们去看 [go-sql-driver/mysql](https://link.zhihu.com/?target=https%3A//github.com/go-sql-driver/mysql) 这个 package 的实现, 就会发现:
...
这里在`init`函数中调用 sql 的标准接口, 注册了 MySQL 的 Driver. 这样做的好处是开发者并不需要显示地调用初始化函数.
...
最后, 标题就算小结了. 再提供一个 Tips:`init`函数并不一定需要写在源文件的最上面, 从语法层面说, 写在任何地方都可以. 标准库里有很多实践的例子. 但从实用和工程化的考量, 可以总结为已下思路:

1. 可以将 `init` 函数写在和 `init` 函数初始化的内容相关的函数上面(特别是有多个 `init` 函数的情况下)
2. 如果没有特别想关的内容, `init` 函数就放在源文件的最上面或最下面(方便被看到)
3. 如果一个 package 只有一个`init`函数, 那尽量放在和 package 同名的源文件里, 例如 go-sql-driver/mysql 就放在`mysql.go`这个文件中